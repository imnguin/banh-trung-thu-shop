...
const FEATURES = [
    {
        ...
        desc: "Giao trong 2-4 giờ nội thành",
    },
    {
        icon: ShieldCheck,
        title: "Cam kết chất lượng",
        desc: "Nguyên liệu chọn lọc, không chất bảo quản",
    },
    {
        icon: Leaf,
        title: "Có bản ít đường",
        desc: "Phù hợp người ăn kiêng, tiểu đường",
    },
];
                ...
                <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 py-14 md:grid-cols-2 md:py-20">
                    <div>
                        ...
                        <p className="mt-4 max-w-md text-base text-primary-foreground/85">
                            Bánh trung thu gia truyền Kim Yến - đặt hàng online
