...
export function OrderProvider({ children }) {
  ...
  function createOrder({ customer, items, subtotal, shippingFee, total, paymentMethod }) {
  ...
  const value = { orders, createOrder, updateOrderStatus, getOrderById, getOrdersByPhone }
